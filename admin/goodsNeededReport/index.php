...
$qry = $conn->query("SELECT * FROM `goodsneeded_list` WHERE DATE(date_created) = '$formattedDate' AND delete_flag = 0 " . ($selectedGoods ? "AND name = '$selectedGoods'" : "") . " ORDER BY `name` ASC ");

?>

<div class="content py-5 px-3 bg-gradient-navy">
    <h2>Goods Needed Report</h2>
</div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm rounded-0" name="goods" id="goods">
                                        ...
                                        $goodsList = $conn->query("SELECT DISTINCT `name` FROM `goodsneeded_list` ORDER BY `name` ASC");
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-1 py-1 text-center"><p class="m-0 truncate-1"><?php echo $row['needed'] ?></p></td>
            ...
            <center>
                ...
                <div class="col-8">
                    <div style="line-height:1em">
                        ...
                        <div class="text-center font-weight-bold h5 mb-0"><h2>Goods Needed Report</h2></div>
...
<script>
    ...
    $(function(){
        $('#filter-form').submit(function(e){
            e.preventDefault();
            location.href = './?page=goodsNeededReport&'+$(this).serialize();
        });
