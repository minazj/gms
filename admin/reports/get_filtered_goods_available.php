<?php
// get_filtered_goods_available.php
...
// SQL query with the goods filter for "Goods Available" table
...
if ($qry->num_rows > 0) {
    while ($row = $qry->fetch_assoc()) {
        // Generate table rows for the "Goods Available" table
        $output .= '<tr>';
        ...
        $output .= '<td class="px-1 py-1 text-center"><p class="m-0 truncate-1">' . $row['available'] . '</p></td>';
