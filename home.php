               ...
               <center>
                    <div class="form-btn">
                        <button class="btn btn-primary">
                           <a class="font-weight-bolder text-light mx-2 text-decoration-none" href="./?p=donatorapp">Donate Goods</a> 
                        </button>

                        <button class="btn btn-primary">
                           <a class="font-weight-bolder text-light mx-2 text-decoration-none" href="./?p=victimapp">Victim Goods</a> 
                        </button>
                    </div>
                </center> 
    </div>
