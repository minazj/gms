<section class="py-5">
    <div class="container">
        ...
        <?php endif;?>
        <h2 class="text-center"><b>Donator Application Form</b></h2>
        <center>
                    ...
                    <div class="card-body container-fluid">
                        <form action="" id="donator-form">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input maxlength="50" placeholder = "Kampung bandar, Sungai Buaya." type="text" class="form-control rounded-pill" id="address" name="address">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group mb-3">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group mb-3">
                                        <label for="goodsneeded_id" class="control-label mx-3">Goods Needed by Shelter</label>
                                        <select class="form-control rounded-pill" id="goodsneeded_id" name="goodsneeded_id">
                                            <option value="" selected disabled></option>
                                            <?php 
                                            $available = $conn->query("SELECT * FROM `goodsneeded_list` where `status` = 1 and delete_flag = 0 order by abs(`name`) asc");
                               ...
                               <!-- <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control rounded-pill" id="goodstype" name="goodstype">
                                            <option value="" selected disabled></option>
                                            <?php 
                                            //$needed = $conn->query("SELECT * FROM `goodsneeded_list` where `status` = 1 and delete_flag = 0 order by abs(`name`) asc");
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group mb-3">
                                        <label for="remark" class="control-label mx-3">Remark</label>
                                        <textarea maxlength="100" placeholder="Enter your comment" type="text" rows="3" class="form-control" id="remark" name="remark"></textarea>
                                    ...
                                    <!--<div class="form-group mb-3">
                                        <label for="schedule" class="control-label mx-3">Date</label>
...
<script>
    $(function(){
        ...
        $('#donator-form').submit(function(e){
            e.preventDefault()
            var _this = $(this)
            var pop_msg = $('<div>')
            ...
            start_loader()
            $.ajax({
                url:_base_url_+"classes/Master.php?f=save_donatorapp",
                method:'POST',
